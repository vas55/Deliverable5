...
public class MainPanel extends JPanel {
    ...
    //System.out.println("value of n is:" + Integer.parseInt(n));
	//System.out.println("values of x is: " + x);
	int q = Integer.parseInt(String.valueOf(x));
	return q;
    }
	...
	//int upY = (y - 1) % size;
	int upY = (y - 1);
	//System.out.println("upy is: " + upY);
	int downY = (y + 1) % size;
	//System.out.println("downY is: " + downY);
	...
	//System.out.println("numNeighbors is: " + numNeighbors);
	//System.out.println("numNeighbors is: " + numNeighbors);
	//System.out.println("convertToInt is: " + convertToInt(numNeighbors));
	return numNeighbors;
	...
	//System.out.println("values of _size:" + _size);
    ...
    public void runContinuous() {
		...
		while (_running) {
			...
			//_r += _maxCount;
	    	//System.out.println("_r: after " + _r);
		    //}
		    //_r = origR;
		    backup();
		    calculateNextIteration();
